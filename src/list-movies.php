...
<div class="flex flex-col justify-center h-full">
    ...
    <?php
    $sql = "SELECT id, title, description, imdb_rating, year, actors, my_rating, my_comment, poster_link FROM projectIMDB.movies ORDER BY title DESC";
    $stmt = $pdo->query($sql);
